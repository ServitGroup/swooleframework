...
// $t1= $csrf->getToken();
// echo $t1,"\n";
// $t2= $csrf->getToken('login-form');
// echo $t2,"\n";
// $t3= $csrf->getToken('something-else');
// echo $t3,"\n";
// echo "--------------------------------------\n";
// echo ( $csrf->validateToken($t1.'1') ? 'true': 'false');
// echo "\n";
// echo ( $csrf->validateToken($t2, 'login-form') ? 'true':'false');
// echo "\n";
// echo ( $csrf->validateToken($t3.'1', 'something-else') ? 'true' : 'false');
// echo "\n";